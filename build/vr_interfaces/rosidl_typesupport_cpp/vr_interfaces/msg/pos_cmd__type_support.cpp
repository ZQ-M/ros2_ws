...
static const _PosCmd_type_support_symbol_names_t _PosCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vr_interfaces, msg, PosCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vr_interfaces, msg, PosCmd)),
  }
};
...
{
  return &::vr_interfaces::msg::rosidl_typesupport_cpp::PosCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vr_interfaces, msg, PosCmd)() {
  return get_message_type_support_handle<vr_interfaces::msg::PosCmd>();
}
