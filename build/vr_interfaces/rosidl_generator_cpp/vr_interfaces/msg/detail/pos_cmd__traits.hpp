...
#ifndef VR_INTERFACES__MSG__DETAIL__POS_CMD__TRAITS_HPP_
#define VR_INTERFACES__MSG__DETAIL__POS_CMD__TRAITS_HPP_
...
[[deprecated("use vr_interfaces::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const vr_interfaces::msg::PosCmd & msg,
  std::ostream & out, size_t indentation = 0)
{
  vr_interfaces::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use vr_interfaces::msg::to_yaml() instead")]]
inline std::string to_yaml(const vr_interfaces::msg::PosCmd & msg)
{
  return vr_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<vr_interfaces::msg::PosCmd>()
{
  return "vr_interfaces::msg::PosCmd";
}

template<>
inline const char * name<vr_interfaces::msg::PosCmd>()
{
  return "vr_interfaces/msg/PosCmd";
}

template<>
struct has_fixed_size<vr_interfaces::msg::PosCmd>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<vr_interfaces::msg::PosCmd>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<vr_interfaces::msg::PosCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // VR_INTERFACES__MSG__DETAIL__POS_CMD__TRAITS_HPP_
