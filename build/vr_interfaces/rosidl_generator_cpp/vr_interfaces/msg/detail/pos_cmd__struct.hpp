...
#ifndef VR_INTERFACES__MSG__DETAIL__POS_CMD__STRUCT_HPP_
#define VR_INTERFACES__MSG__DETAIL__POS_CMD__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__vr_interfaces__msg__PosCmd __attribute__((deprecated))
#else
# define DEPRECATED__vr_interfaces__msg__PosCmd __declspec(deprecated)
#endif
...
struct PosCmd_
{
  ...
  // pointer types
  using RawPtr =
    vr_interfaces::msg::PosCmd_<ContainerAllocator> *;
  using ConstRawPtr =
    const vr_interfaces::msg::PosCmd_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<vr_interfaces::msg::PosCmd_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<vr_interfaces::msg::PosCmd_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      vr_interfaces::msg::PosCmd_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<vr_interfaces::msg::PosCmd_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<vr_interfaces::msg::PosCmd_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<vr_interfaces::msg::PosCmd_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<vr_interfaces::msg::PosCmd_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__vr_interfaces__msg__PosCmd
    std::shared_ptr<vr_interfaces::msg::PosCmd_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__vr_interfaces__msg__PosCmd
    std::shared_ptr<vr_interfaces::msg::PosCmd_<ContainerAllocator> const>
...
using PosCmd =
  vr_interfaces::msg::PosCmd_<std::allocator<void>>;
...
#endif  // VR_INTERFACES__MSG__DETAIL__POS_CMD__STRUCT_HPP_
